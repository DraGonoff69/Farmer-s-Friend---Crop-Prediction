...
function CropPredictor() {
  ...
  const handleSubmit = async (e) => {
    ...
    let userQues = `region: ${region}, soil: ${soil}, temperature: ${temperature} degree celsius, altitude: ${altitude} km, humidity: ${humidity}%, rainfall: ${rainfall} mm. Recommed me the crops that can be grown in India following the given conditions. Write only one crop name.`;
                    ...
                    >
                      ...
                      <div className="md:col-span-6">
                        ...
                        >
                          ...
                          <option value="Arid or Desert Soil">
                            Arid or Desert Soil
                          </option>
                      ...
                      <div className="md:col-span-2">
                        <label for="email">Humidity (in %)</label>
                        <input
                          type="number"
                          name="email"
                          id="email"
                      ...
                      <div className="md:col-span-2">
                        <label for="email">Rainfall (in mm)</label>
                        <input
                          type="text"
                          name="email"
                          id="email"
